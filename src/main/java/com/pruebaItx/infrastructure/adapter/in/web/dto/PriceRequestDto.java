...
/**
 * Data Transfer Object for price query requests.
 * Contains the parameters needed to search for a product price.
 */
@Data
@Builder
@NoArgsConstructor
...
public class PriceRequestDto {
    ...
    /**
     * Date and time when the price should be applied.
    ...
    /**
     * Brand identifier.
     * Must be a positive integer (1 = ZARA).
     */
    ...
    public String toString() {
        return String.format("PriceRequestDto{applicationDate=%s, productId=%d, brandId=%d}",
