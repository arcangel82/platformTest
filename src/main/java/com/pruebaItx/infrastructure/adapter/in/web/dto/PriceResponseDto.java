...
/**
 * Data Transfer Object for price query responses.
 * Contains the price information returned by the price query service.
 */
@Data
@Builder
@NoArgsConstructor
...
public class PriceResponseDto {
     ...
     */
    @Schema(
            description = "Final price amount",
            example = "35.50",
            required = true,
            minimum = "0"
    )
     ...
     */
    public static PriceResponseDto of(Long productId, Long brandId, Integer priceList,
