 ...
 * Tests the web layer functionality including request mapping, response handling,
 * and error scenarios.
 */
...
class PriceControllerTest {
    ...
    @Mock
    private PriceWebMapper priceWebMapper;
    ...
    void shouldHandlePriceScenario1() throws Exception {
        // Given - Test case 1: petición a las 10:00 del día 14 del producto 35455 para la brand 1 (ZARA)
        LocalDateTime applicationDate = LocalDateTime.of(2020, 6, 14, 10, 0, 0);
        Long productId = 35455L;
        Long brandId = 1L;
    ...
    void shouldHandlePriceScenario2() throws Exception {
        // Given - Test case 2: petición a las 16:00 del día 14 del producto 35455 para la brand 1 (ZARA)
    ...
    void shouldHandlePriceScenario3() throws Exception {
        // Given - Test case 3: petición a las 21:00 del día 14 del producto 35455 para la brand 1 (ZARA)
    ...
    void shouldHandlePriceScenario4() throws Exception {
        // Given - Test case 4: petición a las 10:00 del día 15 del producto 35455 para la brand 1 (ZARA)
    ...
    void shouldHandlePriceScenario5() throws Exception {
        // Given - Test case 5: petición a las 21:00 del día 16 del producto 35455 para la brand 1 (ZARA)
