...
/**
 * Integration tests for the Price API. Tests the complete flow from HTTP request through all layers
 * to the database. Uses the real Spring Boot application context with an in-memory H2 database.
 */
...
class PriceIntegrationTest {
  ...
  @Autowired private PriceJpaRepository priceRepository;
